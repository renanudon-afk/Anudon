                    ...
                    <tr>
                      ...
                      <td>{{$d->name}}</td>
                        <td class="u-buttons">
                          ...
                          <a href="#" class="edit-modal-record btn btn-info" data-id="sfddsf"  data-toggle="modal" data-target="#EditForm">
                        <span class="fas fa-edit"></span></a>
                        <a href="#" class="delete-modal-record btn btn-danger" data-id="sdf"  data-toggle="modal" data-target="#DeleteForm">
  ...
  <div class="modal fade" id="AddForm" >
    <div class="modal-dialog modal-dialog-scrollable modal-md" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" role="form" method="post" action="{{url('/store_product')}}">
             @csrf
        <div class="modal-body">
          
              <div class="form-group">
                  <label class="control-label col-sm-4" for="a_name">Product Name:</label>
                    <div class="col-sm-12">
